...
def _try_lazy_install_stt() -> bool:
    ...
    Since the STT plugin is now a separate package that declares
    faster-whisper as a dependency, it's guaranteed to be installed
    when this module is importable. Kept as a stub for API compat.
    """
