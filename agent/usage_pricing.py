...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Announced in limited preview 2026-06-26 at these
    ...
    # Note: the announced Cerebras serving path is a separate serving tier,
    # not covered by these entries. Reasoning effort is a request parameter;
    # OpenAI has not published GPT-5.6 "-pro" model IDs.
