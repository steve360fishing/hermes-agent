...
def call_llm(
    ...
    *,
    ...
    """
    # Preserve one request-local main runtime while enforcing the frozen
    # authoritative route decision above.
    ...
    def _validate_selected_response(response: Any) -> Any:
        return _report_selected_fallback_success(
            _validate_llm_response(
                response, task, provider=resolved_provider, base_url=_base_info
            )
        )
...
async def async_call_llm(
    ...
    *,
    ...
    def _validate_selected_response(response: Any) -> Any:
        return _report_selected_fallback_success(
            _validate_llm_response(
                response, task, provider=resolved_provider, base_url=_client_base
            )
        )
