...
DEFAULT_CODEX_MODELS: List[str] = [
    # GPT-5.6 is a limited preview. Do not hardcode or synthesize preview
    # access: exact Sol/Terra/Luna IDs are surfaced only by live discovery,
    # the authenticated Codex cache, or an already-validated explicit config.
    "gpt-5.5",
    "gpt-5.4-mini",
    "gpt-5.4",
    "gpt-5.3-codex",
